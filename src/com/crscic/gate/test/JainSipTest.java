...
/**
 * 
 * @author zhaokai 2018年12月14日 下午3:25:46
 */
public class JainSipTest implements SipListener
{
	...
	String peerHostPort = "192.168.175.10:5060";
	...
	public Request createRegister(String callId) throws ParseException, InvalidArgumentException
	{
		String fromName = "34020100002000000001";
		String fromSipAddress = "192.168.175.9";
		String fromDisplayName = "K-PC";

		String toSipAddress = "192.168.175.10";
		String toUser = "34020100002000000001";
		String toDisplayName = "GB28181-Sim";
		...
		ViaHeader viaHeader = headerFactory.createViaHeader("192.168.175.9",
...
//		String host = "127.0.0.1";
		 String host = "192.168.175.9:5060";
...
//		request.addHeader(callInfoHeader);
	...
	public void init()
	{
		...
		properties.setProperty("javax.sip.STACK_NAME", "JainSipTest");// "shootistAuth");
...
//		properties.setProperty("gov.nist.javax.sip.TRACE_LEVEL", "16");
		...
		try
		{
			...
			udpListeningPoint = sipStack.createListeningPoint("192.168.175.9", 5060, "udp");
		...
		try
		{
			System.out.println("JainSipTest Process ");
